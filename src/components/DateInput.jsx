...
const DateInput = ({ value, onChange, placeholder = 'Select Date', ariaLabel, className = '' }) => {
  ...
  return (
    <input
      ...
      className={`${className} border border-gray-300 bg-gray-50 px-3 py-2 rounded text-sm w-full sm:w-40 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500`}
      value={value}
